...
from interfaces_package.msg import PsychologicalHealth

class PsychologicalHealthPublisherNode(Node):
    def __init__(self):
        super().__init__("psychological_health_node")
        self.publisher_ = self.create_publisher(PsychologicalHealth, "psychological_health", 10)
